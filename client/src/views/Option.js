      ...
      navigation">
        ...
        <div className="container-xl pt-5 pb-5">
          <div className="text-center">
            ...
            <select className="col-sm-2" id="exampleFormControlSelect1" name="Begin">
          ...
          <option value="07:00">6:30 </option>
            ...
            <select className="col-sm-2" id="exampleFormControlSelect1" name="End">
              <option value="07:00" selected="">6:00 </option>.
          <option value="07:00">6:30 </option>
              <option value="07:00">7:00 </option>
              <option value="07:30">7:30 </option>
          ...
          <div  style={{ margin: '0 auto' }} class="row">
            ...
            <a  style={{ margin: '0 auto' }} class="btn btn-primary" href="#" role="button">More option</a>
          </div>
          <div className="col-sm-2 button1">
            <a style={{ float: 'right' }} name="" id="" class="btn btn-primary" href="#" role="button">Continue</a>
